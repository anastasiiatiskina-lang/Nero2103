...
(function () {
  ...
  var SEO = {
    ...
    'sites': {
      title: 'Сайт для бренда. 150 000 ₽. NERO 21',
      description: 'Разработка сайта под ключ за 150 000 ₽ и четыре недели. Проектирование, вёрстка, публикация, аналитика. Бренд-бук идёт бонусом к сайту.',
